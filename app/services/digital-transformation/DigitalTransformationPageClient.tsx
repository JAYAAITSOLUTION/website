...
import { ArrowLeft, Cloud, CloudCog, Workflow, Monitor, CheckCircle2, Sparkles, TrendingUp, Clock, Zap } from "lucide-react";
...
const benefits = [
  { text: "Reduce operational costs by up to 40%", icon: Zap },
  { text: "Accelerate time-to-market", icon: TrendingUp },
  { text: "Improve business agility", icon: Sparkles },
  { text: "Enhance customer experience", icon: CheckCircle2 },
];

const stats = [
  { value: "40%", label: "Cost Reduction", icon: Zap },
  { value: "60%", label: "Faster Time-to-Market", icon: TrendingUp },
  { value: "85%", label: "Efficiency Improvement", icon: Clock },
];

const process = [
  { step: "01", title: "Discover", description: "Assess current digital maturity and identify opportunities" },
  { step: "02", title: "Strategy", description: "Develop a comprehensive digital transformation roadmap" },
  { step: "03", title: "Execute", description: "Implement cloud, automation, and workplace solutions" },
  { step: "04", title: "Optimize", description: "Continuously monitor and improve for maximum value" },
];
          ...
          <BlurFade delay={0.1} inView>
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-md-on-surface mb-6">
                Digital <span className="bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">Transformation</span>
              </h1>
          ...
          <BlurFade delay={0.1} inView>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-md-on-surface mb-4">
                Transformation <span className="bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">Areas</span>
              </h2>
      ...
      <section className="py-20 lg:py-32 bg-md-surface-container">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <BlurFade delay={0.1} inView>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-md-on-surface mb-4">
                Transformation <span className="bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">Process</span>
              </h2>
              <p className="text-md-on-surface-variant">
            ...
            <BlurFade delay={0.1} inView>
              <div className="space-y-6">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-md-on-surface">
                  Benefits of <span className="bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">Digital Transformation</span>
                </h2>
                <p className="text-md-on-surface-variant">
